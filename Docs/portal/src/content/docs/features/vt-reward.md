...
description: "Thiết kế chi tiết: roll reward token, loot crate (Common/UnCommon/Rare), achievement, thử thách fan-service trong đua và phần thưởng hoàn thành city goal."
---

> Nguồn: `Docs/audit/VT-REWARD_reward.md`, `Docs/c4/model.c4`. View Structurizr: `VT_REWARD_Components`.

> Sơ đồ: xem trang [Architecture](/architecture/) (view LikeC4 `vtReward`).
