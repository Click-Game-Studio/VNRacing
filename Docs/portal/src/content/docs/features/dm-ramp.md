---
title: DM-RAMP RAMP
description: Thiết kế chi tiết — cơ chế phóng xe qua ramp, trigger zone, boost/impulse trên entry và ổn định landing.
---
...
> Sơ đồ: xem trang [Architecture](/architecture/) (view LikeC4 `dmRamp`).
