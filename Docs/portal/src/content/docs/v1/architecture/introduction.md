...
slug: v1/architecture/introduction
---
...
Sơ đồ System Context và sơ đồ Container đều tương tác. Mở trang [Kiến trúc (sơ đồ tương tác)](/v1/architecture) để pan/zoom và bấm vào ô component bất kỳ để nhảy thẳng tới Thiết kế chi tiết của tính năng đó.
