...
description: "Thiết kế chi tiết: tùy biến hình ảnh/hiệu năng, tính CR, lưu/tải
  và phân giải asset trong Customize Room."
slug: v1/features/cu-room
---

> Nguồn: `Docs/audit/CU-ROOM_customize_room.md`, `Docs/c4/model.c4`. View Structurizr: `CU_ROOM_Components`.
> OpenProject: #299.

> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `cuRoom`).
...
| Customize UI BPs | `WBP_PerformanceStat`, WBP\_UI491/493/496 (`/Game/CarCustomize/UI`) | Widget UI garage/tùy biến. |
