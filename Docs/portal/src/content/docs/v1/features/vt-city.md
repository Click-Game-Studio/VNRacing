...
description: "Thiết kế chi tiết: hệ thống tiến trình city, pool mục tiêu theo
  tier, mở khóa city tiếp theo, car unlock và map scene unlock."
slug: v1/features/vt-city
---

> Nguồn: `Docs/audit/VT-CITY_city_progression.md`, `Docs/c4/model.c4`. View Structurizr: `VT_CITY_Components`.

> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `vtCity`).
