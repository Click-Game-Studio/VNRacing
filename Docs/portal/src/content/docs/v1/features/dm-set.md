...
description: Thiết kế chi tiết — cài đặt đồ họa, gameplay, điều khiển, âm thanh,
  ngôn ngữ; load/apply/save. Bao gồm steering-sensitivity pending (#353).
slug: v1/features/dm-set
---
...
> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `dmSet`).
