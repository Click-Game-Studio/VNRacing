...
description: "Tài liệu nội dung: bản đồ đua VN Tour, ba địa điểm Huế City (Đại
  Nội, Quốc Học, Hồ Thuỷ Tiên) và schema DataTable tương ứng."
slug: v1/features/vt-map
---

> Nguồn: `Docs/traceability.md` — mục VT-MAP. OpenProject: #168 / #169.

> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `vtMap`).
