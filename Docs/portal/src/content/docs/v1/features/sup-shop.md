...
description: "Thiết kế chi tiết: sản phẩm cửa hàng, điều phối mua hàng và tích
  hợp UI shop/quảng cáo."
slug: v1/features/sup-shop
---
...
> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `supShop`).
