...
description: "Thiết kế chi tiết: module debug, batch simulation AI/track, phát
  hiện lỗi và xuất dữ liệu."
slug: v1/features/sup-dbg
---
...
> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `supDbg`).
...
|---|---|---|
| `UDebugToolsSubsystem` | nguồn debug | Chứa các DebugModule\_\* cho camera, cheat, gameplay, overlay, progression, rendering, test map, track logic, tutorial và vehicle. |
