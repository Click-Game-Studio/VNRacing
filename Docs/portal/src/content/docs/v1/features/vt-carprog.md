...
description: "Thiết kế chi tiết: Car Rating (CR) khởi đầu theo city, scale CR
  theo upgrade, CR AI theo city/độ khó và Dummy Car."
slug: v1/features/vt-carprog
---

> Nguồn: `Docs/audit/VT-CARPROG_car_progression.md`, `Docs/c4/model.c4`. View Structurizr: `VT_CARPROG_Components`.

> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `vtCarProg`).
