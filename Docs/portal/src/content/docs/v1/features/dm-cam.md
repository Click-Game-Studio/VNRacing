---
title: DM-CAM CAMERA
description: Thiết kế chi tiết — chase camera cho xe player, spring arm, FOV
  curve, incline detection, airborne và bounce simulation.
slug: v1/features/dm-cam
---
...
> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `dmCam`).
