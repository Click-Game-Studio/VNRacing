...
description: "Thiết kế chi tiết: các bước tutorial theo kịch bản, pool tooltip,
  điều kiện trigger và khóa điều khiển."
slug: v1/features/sup-tut
---
...
> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `supTut`).
