...
description: "Thiết kế chi tiết: client Nakama, matchmaking, waiting room và
  ranh giới race online mục tiêu."
slug: v1/features/gm-mp
---

> Nguồn: `Docs/audit/GM-MP_multiplayer.md`, `Docs/c4/model.c4`. View Structurizr: `GM_MP_Components`.
> OpenProject: #273.

> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `gmMp`).
