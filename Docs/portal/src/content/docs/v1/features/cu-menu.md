---
title: CU-MENU — Main menu_Level
description: "Level và UI shell main menu: cổng vào Customize Room, Game Mode,
  VN Tour và Settings."
slug: v1/features/cu-menu
---

> OpenProject: #320.

> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `cuMenu`).
