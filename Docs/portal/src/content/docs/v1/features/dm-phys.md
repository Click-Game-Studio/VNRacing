...
description: Thiết kế chi tiết — mô phỏng xe player/AI, suspension, movement
  component và cấu hình Blueprint cho xe. Không bao gồm camera, NOS hay ramp.
slug: v1/features/dm-phys
---
...
DM-PHYS lo phần mô phỏng xe player/AI: vehicle actor, cập nhật wheel/suspension, movement component, các factory helper và cấu hình Blueprint cho xe. Bao gồm logic collision/wall-correction (OpenProject #284/#278 "Dev\_Implement\_Collision Debug").

> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `dmPhys`).
