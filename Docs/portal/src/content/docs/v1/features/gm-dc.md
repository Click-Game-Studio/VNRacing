...
description: "Gap doc: tính năng được yêu cầu nhưng chưa hiện thực — pool nhiệm
  vụ hằng ngày, reset theo ngày và màn hình daily challenge."
slug: v1/features/gm-dc
---

> OpenProject: #274.

> Sơ đồ: xem trang [Architecture](/v1/architecture/) (view LikeC4 `gmDc`).
