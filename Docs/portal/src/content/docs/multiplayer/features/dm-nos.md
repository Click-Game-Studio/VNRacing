---
title: DM-NOS NOS
description: Thiết kế chi tiết — cơ chế nitro boost cho player và AI, checkpoint nạp lại NOS và logic AI quyết định khi dùng NOS.
---
...
> Sơ đồ: xem trang [Architecture](/architecture/) (view LikeC4 `dmNos`).
