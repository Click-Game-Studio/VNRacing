...
description: "Thiết kế chi tiết: mở khóa area/track theo vị thứ, chọn track để đua, tính lại độ khó track khi CR xe thay đổi."
---

> Nguồn: `Docs/audit/VT-TRACK_area_track_unlock.md`, `Docs/c4/model.c4`. View Structurizr: `VT_TRACK_Components`.

> Sơ đồ: xem trang [Architecture](/architecture/) (view LikeC4 `vtTrack`).
