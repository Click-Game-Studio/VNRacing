...
description: "Thiết kế chi tiết: quản lý item sở hữu, equip/favorite, tra cứu định nghĩa item và lưu trữ."
---
...
> Sơ đồ: xem trang [Architecture](/architecture/) (view LikeC4 `supInv`).
