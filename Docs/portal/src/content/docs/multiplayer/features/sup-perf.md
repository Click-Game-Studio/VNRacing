...
description: "Thiết kế chi tiết: instrumentation hiệu năng runtime, significance culling và warmup PSO/shader."
---
...
> Sơ đồ: xem trang [Architecture](/architecture/) (view LikeC4 `supPerf`).
