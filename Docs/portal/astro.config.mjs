...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      // Versioned docs: cutting a version snapshots docs+assets into
      // src/content/docs/<slug>/. Diagrams are versioned separately via LikeC4
      // multi-project (likec4/<slug>/), wired through DiagramView's `project` prop.
      plugins: [starlightVersions({ versions: [{ slug: 'v1' }] })],
