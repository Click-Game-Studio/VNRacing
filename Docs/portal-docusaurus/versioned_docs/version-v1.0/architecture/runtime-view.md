...
description: Các kịch bản runtime chính — vòng đời race, vòng lặp customization, backend/multiplayer, hỗ trợ hiệu năng.
---

Các component view được nhắc dưới đây đều tương tác được trên trang [Kiến trúc](/architecture) (F02, F06, F11, F17).
