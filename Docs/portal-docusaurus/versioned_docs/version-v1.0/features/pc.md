...
description: "Cấu hình dự án và hạ tầng DevOps: packaging, chia chunk CDN, upload AWS và k6 load test."
---
...
Không có sơ đồ C4 component view cho PC — xem tổng quan kiến trúc hệ thống tại trang [Architecture](/architecture/).
