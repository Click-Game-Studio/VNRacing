...
description: Chuyển cập nhật ranking của cuộc đua ra khỏi Tick mỗi frame và bỏ phần quét world phía client.
slug: /decisions/0001-ranking-update-off-tick
---
...
- LD: [DM-RACE Basic Racing](/features/dm-race) §1.4, §2.4, §2.5
