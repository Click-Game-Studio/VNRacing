...
GDD Mô tả các tùy chọn Setting của Game.  
**Change Log:**

- First Version (20250919)

1. # **Concepts** 

1. ## **Goals**

- Màn hình Setting cho phép người chơi tinh chỉnh một số tùy chọn liên quan tới Âm thanh, Hình ảnh và các mặt khác của Game.


2. ## **Phân loại và mô tả các tùy chọn Setting**

[VN Racing\_Tables](https://docs.google.com/spreadsheets/d/1d7CZivAtN3ZrHAQLSYUeyCf9DqPC5Uge7Ubitclquk4/edit?gid=399237740#gid=399237740&range=A1:F1)

| SETTINGS |  |  |  |  |  |  |
| ----- | :---- | :---- | :---- | :---- | :---- | ----- |
| **\#** | **Name** | **Categories** | **Descriptions** | **Setting Types** | **Details** | **Default** |
| 1 | Tap To Steer | Controls | Active chế độ lái mặc định. | Toggle | Cùng một lúc chỉ có thể Active 1 cái. | Active |
...
| 13 | Frame Rate Limit | Graphic | Limit Frame Rate của Game | Multiple Choices | 30fps, 60fps | 60 FPS |
...
| 21 | English | Language | Đổi tùy chọn ngôn ngữ của Game sang Tiếng Anh | Toggle | Cùng một lúc chỉ có thể Active 1 cái. | Active |
| 22 | Vietnamese | Language | Đổi tùy chọn ngôn ngữ của Game sang Tiếng Việt | Toggle |  | Not Active |
